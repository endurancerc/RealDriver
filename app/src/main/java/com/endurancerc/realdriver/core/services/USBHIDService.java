package com.endurancerc.realdriver.core.services;
...
import com.endurancerc.realdriver.core.USBUtils;
...
import com.endurancerc.realdriver.ui.LoginActivity;
...
public class USBHIDService extends AbstractUSBHIDService {
	...
	public CharSequence onBuildingDevicesList(UsbDevice usbDevice) {
		...
		return "Device Name: " + usbDevice.getProductName();
	}
